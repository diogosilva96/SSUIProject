...
public class MediaPlayer extends Activity  {
    ...
    private AudioListManipulator audioListManipulator;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        audioListManipulator = (AudioListManipulator)intent.getSerializableExtra("AudioListManipulator");
        init();
        initMediaPlayer();
    ...
    public void handleNextClick(View v){
        emptyMediaPlayer();
        audioListManipulator.nextAudio();
        initMediaPlayer();
    }

    public void handlePreviousClick(View v){
        emptyMediaPlayer();
        audioListManipulator.previousAudio();
        initMediaPlayer();
    }

    public void handleShuffleClick(View v){
        if(audioListManipulator.getShuffleMode()){
            audioListManipulator.setShuffleMode(false);
            ...
            audioListManipulator.setShuffleMode(true);
    ...
    public void handleFilesClick(View v) {
        super.onBackPressed();// volta activity anterior
    }
    ...
    private void initMediaPlayer(){
        mediaPlayer = android.media.MediaPlayer.create(this, Uri.parse(Environment.getExternalStorageDirectory().getPath()+ audioListManipulator.getCurrentAudioPath()));
        ...
        tvAudioTitle.setText(audioListManipulator.getCurrentAudioName());
        btnPlay.setImageResource(R.drawable.ic_play);
        if(mediaPlayer != null) {
